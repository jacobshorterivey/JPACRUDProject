...
INSERT INTO `videogame` (`id`, `title`, `developer`, `publisher`, `description`, `esrb_rating`, `metacritic_score`, `release_date`, `boxart_url`) VALUES (6, 'Final Fantasy IX\nFinal Fantasy IX', 'Square', 'Square', 'The last Final Fantasy for the PlayStation, Final Fantasy IX returns to the pure fantasy roots that spawned the series. This latest installment features highly detailed characters, vehicles, and environments, and breathtaking cinema-graphics.', 'T', 84, '2000-07-07', 'https://upload.wikimedia.org/wikipedia/en/5/51/Ffixbox.jpg');
